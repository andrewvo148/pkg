...
func RegisterLibraryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LibraryServer) error {
	...
	mux.Handle("GET", pattern_Library_GetBook_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.Library/GetBook", runtime.WithHTTPPathPattern("/v1/{name=shelves/*/books/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Library_GetBook_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Library_GetBook_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterLibraryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LibraryClient) error {
	...
	mux.Handle("GET", pattern_Library_GetBook_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.Library/GetBook", runtime.WithHTTPPathPattern("/v1/{name=shelves/*/books/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Library_GetBook_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Library_GetBook_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 4, 5, 3}, []string{"v1", "shelves", "books", "name"}, ""))
)
